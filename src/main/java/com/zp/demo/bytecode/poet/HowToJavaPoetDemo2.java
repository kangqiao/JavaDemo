package com.zp.demo.bytecode.poet;
 ...
 */
public class HowToJavaPoetDemo2 {
    ...
    public static FieldSpec wildcardTypeField() {
        ...
        return FieldSpec.builder(ParameterizedTypeName.get(ClassName.get("java.util", "List"),
                WildcardTypeName.subtypeOf(ClassName.get("java.lang", "String"))),
                "mWildcardField",
                Modifier.PRIVATE)
                .build();
    }
